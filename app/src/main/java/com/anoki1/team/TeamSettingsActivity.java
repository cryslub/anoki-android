...
public class TeamSettingsActivity extends SubActivityBase {
    ...
    public void load(){
        ...
        backGroundRest("team/detail", "POST", search, Team.class, new CallBack<Team>() {
            ...
            public void success(Team team) {
                ...
                TeamSettingsActivity.this.team = team;
    ...
    public void leave(View view){
        ...
        backGroundRest("team/leave", "POST", member, Response.class, new CallBack<Response>() {
  ...
  //      rest("team", "DELETE", team);
        backGroundRest("team", "DELETE", team, Response.class, new CallBack<Response>() {
