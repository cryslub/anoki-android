...
import com.anoki1.etc.BillingActivity;
...
class MemberViewHolder extends ViewHolderBase<Member> {
    ...
    public void accept(){
        ...
        if(this.activity != null) {
            ((TeamMembersActivity) this.activity).load();
        }
...
public class TeamMembersActivity extends SubActivityBase implements SearchFragment.OnFragmentInteractionListener{
    ...
    private void setMemberList(){
        ...
        backGroundRest("team/members", "POST", search, listType, new CallBack<List<Member>>() {
            ...
            public void success(List<Member> memberList) {
                ...
                setRecyclerView(TeamMembersActivity.this.memberList, memberAdapter);
    ...
    private void setRequestList(){
        ...
        backGroundRest("team/members", "POST", search, listType, new CallBack<List<Member>>() {
            ...
            public void success(List<Member> memberList) {
                requestAdapter
                        = new  GeneralRecyclerViewAdapter<Member,MemberViewHolder> (memberList,R.layout.layout_request_row, MemberViewHolder.class,TeamMembersActivity.this);

                setRecyclerView(TeamMembersActivity.this.requestList, requestAdapter);
